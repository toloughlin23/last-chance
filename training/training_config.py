...
class TrainingPresets:
    ...
    def six_month_training() -> Dict[str, Any]:
        ...
        return {
            ...
            'training_end_date': datetime(2024, 12, 31),
            'symbols': ['AAPL', 'GOOGL', 'MSFT', 'AMZN', 'TSLA', 'NVDA', 'META', 'JPM', 'V', 'JNJ',
                      'WMT', 'PG', 'MA', 'HD', 'DIS', 'ADBE', 'NFLX', 'CRM', 'PFE', 'TMO'],
            'lookback_window': 20,
            'news_lookback_hours': 24,
            'validate_no_future_data': True,
            'save_checkpoints': True,
    ...
    def one_year_training() -> Dict[str, Any]:
        ...
        return {
            ...
            'symbols': [
                ...
                # Healthcare
                'JNJ', 'UNH', 'PFE', 'TMO', 'ABT', 'CVS', 'DHR',
                # Consumer
                'WMT', 'PG', 'HD', 'DIS', 'NKE', 'MCD', 'SBUX',
                # Industrial
                'BA', 'CAT', 'MMM', 'GE', 'HON', 'UPS', 'RTX'
            ],
            'lookback_window': 20,
            'news_lookback_hours': 24,
            'validate_no_future_data': True,
...
class TrainingValidation:
    ...
    @staticmethod
    def validate_sufficient_data(start_date: datetime, end_date: datetime, min_days: int = 60) -> bool:
