...
def debug_polygon_market_cap():
    ...
    try:
        ...
        if results:
            ...
            for i, ticker in enumerate(results[:3]):
                ...
                if 'market_cap' in ticker:
                    ...
                    print(f"     Market Cap: NOT IN TICKER DATA")
        ...
        for symbol in test_symbols:
            ...
            try:
                ...
                if details.get("results"):
                    ...
                    print(f"   Primary Exchange: {result.get('primary_exchange', 'NOT FOUND')}")
                else:
            ...
            try:
                ...
                if results and len(results) > 0:
                    ...
                    if 'market_cap' in first_ticker:
                        print(f"    First ticker market_cap: {first_ticker['market_cap']}")
                    else:
                        print(f"    First ticker market_cap: NOT FOUND")
        ...
        try:
            ...
            test_data = polygon_client.get_aggs("AAPL", 1, "day", "2024-01-01", "2024-01-02", limit=1)
