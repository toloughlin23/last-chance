...
def diagnose_filtering():
    ...
    try:
        ...
        symbols = [ticker.get("ticker") for ticker in results if isinstance(ticker.get("ticker"), str)]
        ...
        for i, symbol in enumerate(test_symbols):
            ...
            try:
                ...
                if market_cap >= 10_000_000_000:
                    passed_market_cap += 1
                    print(f"   ✅ Market Cap: PASS")
                else:
                    print(f"   ❌ Market Cap: FAIL (< $10B)")
                    continue
            ...
            try:
                ...
                if med_dollar <= 5.0 and med_bps <= 5000:
                    passed_spreads += 1
                    print(f"   ✅ Spreads: PASS")
                else:
                    print(f"   ❌ Spreads: FAIL (too wide)")
                    continue
            ...
            try:
                ...
                if len(prices) < 5:
                    print(f"   ❌ ATR: Not enough price data")
                    continue
                ...
                if 0.5 <= atr_pct <= 8.0:  # Reasonable ATR range
                    ...
                    print(f"   ❌ ATR: FAIL (outside 0.5-8.0%)")
                    continue
